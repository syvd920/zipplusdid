...
document.getElementById('caseCards').innerHTML=names.map((n,i)=>`<article class="card"><div class="imgbox"><div class="rank">${i+1}</div><div class="office-img"></div></div><div class="card-body"><h3>${n}</h3><p>매물 사진·영상 자동 송출 · 사무실 이미지 개선</p><div class="price">광고수익 <span class="red">40% 공유</span><br>월 최대 <span class="red">400,000원</span></div></div></article>`).join('');
